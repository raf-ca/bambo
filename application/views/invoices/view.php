...
<div class="invoiceViewHold">
	<div id="companyDetails">
		...
		<p>
			...
			<?php if ($companyInfo->province != '') {echo $companyInfo->province;}{echo '<br />';}?>
			<?php if ($companyInfo->city != '') {echo $companyInfo->city;}?>
			<?php if ($companyInfo->postal_code != '') {echo ' ' . $companyInfo->postal_code;}{echo '<br />';}?>
			<?php if ($companyInfo->country != '') {echo $companyInfo->country;}{echo '<br />';}?>
			<?php echo auto_link(prep_url($companyInfo->website));?>
			<?php if ($companyInfo->tax_code != '') {echo '<br /><br />'.$this->lang->line('settings_tax_code').': '.$companyInfo->tax_code;}?>
	...
	<p>
		...
		<?php if ($row->province != '') {echo $row->province;}{echo '<br />';}?>
		<?php if ($row->city != '') {echo $row->city;}?>
		<?php if ($row->postal_code != '') {echo ' ' . $row->postal_code;}{echo '<br />';}?>
		<?php if ($row->country != '') {echo $row->country;}{echo '<br />';}?>
		<?php echo auto_link(prep_url($row->website));?>
		<?php if ($row->tax_code != '') {echo '<br /><br />'.$this->lang->line('settings_tax_code').': '.$row->tax_code;}?>
